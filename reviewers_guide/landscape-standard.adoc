...
The key question this section will answer is where and how GeoPose fits into the landscape of standards. By examining some of the relevant standards, this section illustrates the gaps which GeoPose is designed to fill.
...
|===
|*Standard* |*Graphical Frame of Reference* |*Local Spatial CRS* |*Geodedic CRS* |*6DOF as entity or attribute?* |*Temporality*
