...
:titletext: OGC GeoPose Reviewers Guide
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Approval Date:   <2023-01-12>
|Publication Date:   <YYYY-MM-DD>
|External identifier of this OGC(R) document: http://www.opengis.net/doc/UG/geopose-reviewers
|Internal reference number of this OGC(R) document:    22-000r1
|Category: OGC(R) User Guide
...
include::clause_5_geopose_glossary.adoc[]

include::clause_6_GeoPose_SWG_Process.adoc[]

include::clause_6_1_Conceptual_Model.adoc[]

include::clause_6_2_Logical_Model.adoc[]

include::clause_6_3_standardization_targets.adoc[]

include::landscape-standard.adoc[]

include::closing_clause.adoc[]
