...
image:./images/glossary/LocalPositioning.png[Local Positioning, pdfwidth=5cm]
...
image:./images/glossary/GlobalPositioning.png[Global Positioning, pdfwidth=5cm]
...
image:./images/glossary/UniversalPositioning.png[Universal Positioning, pdfwidth=5cm]
