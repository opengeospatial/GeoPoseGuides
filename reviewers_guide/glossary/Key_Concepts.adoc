...
image:./images/glossary/Frame.png[Frame, pdfwidth=5cm] 
...
| [[def_pose]] **Pose** +
image:./images/glossary/Pose.png[Pose, pdfwidth=5cm]
...
image:./images/glossary/SceneGraph.png[Pose Chain, pdfwidth=5cm]
...
image:./images/glossary/GeoPose.png[GeoPose, pdfwidth=5cm]
...
image:./images/glossary/location.png[Location, pdfwidth=5cm]
