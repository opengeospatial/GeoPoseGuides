...
image:./images/glossary/Animation.png[Animation, pdfwidth=5cm] 
...
| [[def_motion]] **Motion** +
image:./images/glossary/Motion.png[Motion, pdfwidth=5cm]
...
image:./images/glossary/Trajectory.png[Trajectory, pdfwidth=5cm]
...
| [[def_gesture]] **Gesture** +
image:./images/glossary/Gesture.png[Gesture, pdfwidth=5cm]
