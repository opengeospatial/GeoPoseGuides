...
image:../users_guide/figures/glossary/EulerAngles.png[Euler Angles,320,320] +
...
image:../users_guide/figures/glossary/AircraftPrincipledAxes.png[Aircraft Principal Axes,320,320] +
...
image:../users_guide/figures/glossary/Quaternions.png[Quaternions,320,320] +
...
image:../users_guide/figures/glossary/LookAtSystem.png[Look-At Systems,320,320] +
