...
image:../users_guide/figures/glossary/EulerAngles.png[Euler Angles, width=256, pdfwidth=5cm] +
...
image:../users_guide/figures/glossary/AircraftPrincipledAxes.png[Aircraft Principal Axes, width=256, pdfwidth=5cm] +
...
image:../users_guide/figures/glossary/Quaternions.png[Quaternions, width=256, pdfwidth=5cm] +
...
image:../users_guide/figures/glossary/LookAtSystem.png[Look-At Systems, width=256, pdfwidth=5cm] +
