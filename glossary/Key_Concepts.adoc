...
image:../users_guide/figures/glossary/Frame.png[Frame, width=256, pdfwidth=5cm] +
...
| [[def_pose]] **Pose** +
image:../users_guide/figures/glossary/Pose.png[Pose, width=256, pdfwidth=5cm] +
...
image:../users_guide/figures/glossary/SceneGraph.png[Pose Chain, width=256, pdfwidth=5cm] +
...
| [[def_geopose]] **GeoPose** +
image:../users_guide/figures/glossary/GeoPose.png[GeoPose, width=256, pdfwidth=5cm] +
